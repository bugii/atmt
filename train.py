...
def get_args():
    ...
    parser.add_argument('--save-dir', default='checkpoints_bpe_dropout',
...
def main(args):
    ...
    for epoch in range(last_epoch + 1, args.max_epoch):
        ...
        if args.dropout:
            # implement BPE dropout here
            bpe.bpe_dropout(0.1)
            # Build new training datasets to make use of bpe dropout at training time
            os.system('python3 preprocess.py --target-lang en --source-lang de --vocab-src bpe_dropout/prepared_data/dict.de --vocab-trg bpe_dropout/prepared_data/dict.en --dest-dir bpe_dropout/prepared_data/ --train-prefix bpe_dropout/preprocessed_data/train --threshold-src 1 --threshold-tgt 1 --num-words-src 4000 --num-words-tgt 4000')
            # load new datasets
